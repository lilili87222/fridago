...
void ____Imp____(){
    ...
    IMPORT(frida_device_manager_new_with_nonlocal_backends_only);
    IMPORT(frida_device_manager_new_with_socket_backend_only);
    IMPORT(frida_device_manager_construct_with_nonlocal_backends_only);
    IMPORT(frida_device_manager_construct_with_socket_backend_only);
    ...
    IMPORT(frida_device_open_service);
    IMPORT(frida_device_open_service_finish);
    IMPORT(frida_device_open_service_sync);
    IMPORT(frida_device_unpair);
    IMPORT(frida_device_unpair_finish);
    IMPORT(frida_device_unpair_sync);
    ...
    IMPORT(frida_session_options_get_emulated_agent_path);
    IMPORT(frida_session_options_set_realm);
    IMPORT(frida_session_options_set_persist_timeout);
    IMPORT(frida_session_options_set_emulated_agent_path);
    ...
    IMPORT(frida_service_is_closed);
    IMPORT(frida_service_activate);
    IMPORT(frida_service_activate_finish);
    IMPORT(frida_service_activate_sync);
    IMPORT(frida_service_cancel);
    IMPORT(frida_service_cancel_finish);
    IMPORT(frida_service_cancel_sync);
    IMPORT(frida_service_request);
    IMPORT(frida_service_request_finish);
    IMPORT(frida_service_request_sync);
    ...
    IMPORT(frida_session_snapshot_script);
    IMPORT(frida_session_snapshot_script_finish);
    IMPORT(frida_session_snapshot_script_sync);
    ...
    IMPORT(frida_script_enable_debugger);
    IMPORT(frida_script_enable_debugger_finish);
    IMPORT(frida_script_enable_debugger_sync);
    IMPORT(frida_script_disable_debugger);
    IMPORT(frida_script_disable_debugger_finish);
    IMPORT(frida_script_disable_debugger_sync);
    IMPORT(frida_snapshot_options_new);
    IMPORT(frida_snapshot_options_get_warmup_script);
    IMPORT(frida_snapshot_options_get_runtime);
    IMPORT(frida_snapshot_options_set_warmup_script);
    IMPORT(frida_snapshot_options_set_runtime);
    IMPORT(frida_script_options_new);
    IMPORT(frida_script_options_get_name);
    IMPORT(frida_script_options_get_snapshot);
    IMPORT(frida_script_options_get_snapshot_transport);
    IMPORT(frida_script_options_get_runtime);
    IMPORT(frida_script_options_set_name);
    IMPORT(frida_script_options_set_snapshot);
    IMPORT(frida_script_options_set_snapshot_transport);
    ...
    IMPORT(frida_control_service_new_with_device_finish);
    IMPORT(frida_control_service_get_endpoint_params);
    IMPORT(frida_control_service_get_options);
    IMPORT(frida_control_service_construct_with_device_finish);
    ...
    IMPORT(frida_compiler_new);
    IMPORT(frida_compiler_get_manager);
    IMPORT(frida_compiler_build);
    IMPORT(frida_compiler_build_finish);
    IMPORT(frida_compiler_build_sync);
    IMPORT(frida_compiler_watch);
    IMPORT(frida_compiler_watch_finish);
    IMPORT(frida_compiler_watch_sync);
    IMPORT(frida_compiler_options_new);
    IMPORT(frida_compiler_options_get_project_root);
    IMPORT(frida_compiler_options_get_source_maps);
    IMPORT(frida_compiler_options_get_compression);
    IMPORT(frida_compiler_options_set_project_root);
    IMPORT(frida_compiler_options_set_source_maps);
    IMPORT(frida_compiler_options_set_compression);
    IMPORT(frida_build_options_new);
    IMPORT(frida_watch_options_new);
    IMPORT(frida_error_quark);
    IMPORT(frida_runtime_get_type);
    IMPORT(frida_device_type_get_type);
    IMPORT(frida_source_maps_get_type);
    IMPORT(frida_js_compression_get_type);
    ...
    IMPORT(frida_snapshot_transport_get_type);
    ...
    IMPORT(frida_service_get_type);
    IMPORT(frida_session_get_type);
    IMPORT(frida_script_get_type);
    IMPORT(frida_snapshot_options_get_type);
    ...
    IMPORT(frida_compiler_get_type);
    IMPORT(frida_compiler_options_get_type);
    IMPORT(frida_build_options_get_type);
    IMPORT(frida_watch_options_get_type);
}
